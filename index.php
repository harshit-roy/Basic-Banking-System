...
<body>
  ...
  <div class="container-fluid">
    <h1><br><br>Sparks Banking System</h1>
    <p><br>You can transfer money from one customer account to another and can also check the transfer history of each transaction.</p>
